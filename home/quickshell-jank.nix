# Copied from https://github.com/nix-community/home-manager/blob/6564ee29d0521af3feba937a91024e6a3e77a8b6/modules/programs/quickshell.nix
{
  config,
  lib,
  pkgs,
        ...
        systemd.user.services.quickshell = {
          ...
          Service = {
            ExecStart =
              ...
              + (
                if cfg.activeConfig == null
                then ""
                else " --config ${cfg.activeConfig}"
              );
            Restart = "on-failure";
          };
